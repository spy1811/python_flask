...
CREATE TABLE `principle` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_principle_pphone` (`pphone`),
  KEY `ix_principle_pname` (`pname`),
  KEY `ix_principle_pemail` (`pemail`)
...
INSERT INTO `principle` VALUES (2,'Naren Mergu','principle@gmail.com','9887765423');
